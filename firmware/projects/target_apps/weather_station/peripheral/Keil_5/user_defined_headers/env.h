...
extern const struct attm_desc env_txps_att_db[ENV_IDX_NB];
...
/// TX Power Service
extern const att_svc_desc_t env_txps_svc;
/// TX Power Service -TX Power Level Characteristic
extern const struct att_char_desc env_txps_tx_power_lvl_char;
 ...
 ****************************************************************************************
 */
void env_disable(uint16_t conhdl); 
