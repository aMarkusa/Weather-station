...
static int env_alert_ind_handler(ke_msg_id_t const msgid,
                                   struct env_alert_ind const *param,
                                   ke_task_id_t const dest_id,
                                   ke_task_id_t const src_id)
{
...
{
    {APP_PROXR_TIMER,                       (ke_msg_func_t)app_env_timer_handler},
    {PROXR_ALERT_IND,                       (ke_msg_func_t)env_alert_ind_handler},
};
